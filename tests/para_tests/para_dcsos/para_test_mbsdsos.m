    ...
    for density=setdensity
        for d=setd
            ...
            parfor i=1:2
                ...
                tic
                [~,~,DSOS] = poly2dsos(p,method,ismatrixform);
                t=toc;
                
                fprintf('MBS-DSOS within %.3f seconds.\n',t);
                parsave([outputdir,'/',filename],p,N,d,density,DSOS,[],t);
            end
            count=count+10;
        end
    end
